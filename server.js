...
http.listen(3000, function(){
			...
			if(user == null){
				...
				database.collection("posts").findOne({
					...
					if(post == null){
						...
						database.collection("posts").updateOne({
							$and: [{
								"_id": ObjectId(postId) //5eed7b9f866eff3d200c32ed
							},{
								"comments._id": ObjectId(commentId) //5eef84bf5574232a9c409329
							}]
						},{
							$push: {
								"comments.$.replies": {
	...
	/* 
		reply_id:           "5eef85b31a4fe23ee4aa1f94",
		ObjectId_postId:    "5eed7b9f866eff3d200c32ed",
		ObjectId_commentId: "5eef84bf5574232a9c409329"
	
		reply_id:"5ef01cd8c7ff272618933324", //uniqueID
		ObjectId_postId:"5eed7b9f866eff3d200c32ed", //correct
		ObjectId_commentId:"5eef84bf5574232a9c409329" // not match
